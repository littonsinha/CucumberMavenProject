...
public class Login
{
	...
	public void user_creates_a_trip()
	{
		System.out.println("User creates a trip");
		driver.findElement(By.cssSelector("input[value='oneway']")).click();
		WebElement departingFrom = driver.findElement(By.cssSelector("select[name='fromPort']"));
		Select selectDeparture = new Select(departingFrom);
		selectDeparture.selectByVisibleText("London");
		WebElement fromMonth = driver.findElement(By.cssSelector("select[name='fromMonth']"));
		Select selectFromMonth = new Select(fromMonth);
		selectFromMonth.selectByVisibleText("March");
